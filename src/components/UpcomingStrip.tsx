...
function SkeletonCard() {
  return (
    <div className="w-[190px] flex-shrink-0 rounded-2xl border border-white/[0.06] bg-white/[0.03] p-4 flex flex-col gap-3">
    ...
    <section className="relative z-10 border-t border-white/[0.06] py-10">
      <div className="mx-auto max-w-screen-xl px-4 sm:px-8">
        ...
        <motion.h2
          ...
          className="mb-5 text-xl font-black tracking-tight text-slate-100"
        >
          Próximos Eventos
        </motion.h2>
        ...
        <div
          ...
          style={{ scrollSnapType: 'x mandatory', scrollbarWidth: 'thin', scrollbarColor: 'rgba(255,255,255,0.1) transparent' }}
          role="list"
        ...
        >
          {loading
            ...
            : slice.length === 0
            ? <p className="text-sm text-slate-500 py-4">Agrega eventos en Supabase para verlos aquí.</p>
            : slice.map((ev, i) => (
